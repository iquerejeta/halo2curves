...
const MULTIPLICATIVE_GENERATOR: Fp = Fp::from_raw_unchecked([0x02, 0x00, 0x00, 0x00, 0x00, 0x00]);

// TODO: Can we simply put 0 here::
const ROOT_OF_UNITY: Fp = Fp::zero();
...
// L=(k^3-1).roots();L
const ZETA: Fp = Fp::from_raw_unchecked([
    0x30f1361b798a64e8,
    0xf3b8ddab7ece5a2a,
    0x16a8ca3ac61577f7,
    0xc26a2ff874fd029b,
