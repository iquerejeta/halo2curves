...
impl<'a, 'b> Add<&'b G1Affine> for &'a G1Affine {
    ...
    fn add(self, rhs: &'b G1Affine) -> G1Projective {
        G1Projective::from(self).add_mixed(rhs)
    }
}
...
impl CurveExt for G1Projective {
    ...
    const CURVE_ID: &'static str = "bls12-381-g1";
...
fn test_mul_by_x() {
    ...
    let x = if crate::bls12_381::BLS_X_IS_NEGATIVE {
        -Scalar::from(crate::bls12_381::BLS_X)
    } else {
        Scalar::from(crate::bls12_381::BLS_X)
    };
...
fn test_clear_cofactor() {
    ...
    let h_eff = Scalar::from(1) + Scalar::from(crate::bls12_381::BLS_X);
